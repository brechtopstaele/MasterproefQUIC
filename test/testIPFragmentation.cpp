...
static void test4in4(bool defrag) {
  ...
  uint icmp_packets = 0;
  getProtocols("./pcaps/ip_fragmentation/4in4_outer.pcap", protocols, state,
               [&](pfwl_status_t, pfwl_dissection_info_t r) {
...
static void testGeneric(bool defrag) {
  ...
  std::vector<uint> protocols;
  size_t packet_id = 1;
  getProtocols("./pcaps/ip_fragmentation/correct_1.pcap", protocols, state,
               [&](pfwl_status_t, pfwl_dissection_info_t r) {
                 if (packet_id == 23) {
