...
TEST(L3Dissection, 4in4) {
  ...
  getProtocols("./pcaps/L3/4in4.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
...
TEST(L3Dissection, 4in6) {
  ...
  std::vector<uint> protocols;
  size_t id = 0;
  getProtocols("./pcaps/L3/4in6.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
    if (id == 0) {
      struct sockaddr_in src, dst;
...
TEST(L3Dissection, 6in4) {
  ...
  std::vector<uint> protocols;
  size_t id = 0;
  getProtocols("./pcaps/L3/6in4.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
    if (id == 0) {
...
TEST(L3Dissection, ipv6_hdr_dstopts) {
  ...
  std::vector<uint> protocols;
  size_t id = 0;
  getProtocols("./pcaps/L3/ipv6_hdr_dstopt.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
    if (id == 0) {
      struct sockaddr_in6 src, dst;
...
TEST(L3Dissection, ipv6_hdr_hopbyhop) {
  ...
  std::vector<uint> protocols;
  size_t id = 0;
  getProtocols("./pcaps/L3/ipv6_hdr_hopbyhop.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
    if (id == 0) {
      struct sockaddr_in6 src, dst;
...
TEST(L3Dissection, ipv6_hdr_routing) {
  ...
  std::vector<uint> protocols;
  size_t id = 0;
  getProtocols("./pcaps/L3/ipv6_hdr_routing.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
    if (id == 0) {
      struct sockaddr_in6 src, dst;
...
TEST(L3Dissection, rsvp) {
  ...
  std::vector<uint> protocols;
  size_t id = 0;
  getProtocols("./pcaps/L3/rsvp.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
    if (id == 0) {
      struct sockaddr_in src, dst;
...
TEST(L3Dissection, truncated) {
  const char *truncated_files[] = {"./pcaps/L3/truncated_tcp.pcap", "./pcaps/L3/truncated_udp.pcap",
                                   "./pcaps/L3/truncated_icmp.pcap", "./pcaps/L3/truncated_ip.pcap"};
  for (auto filename : truncated_files) {
    pfwl_state_t *state = pfwl_init();
    std::vector<uint> protocols;
    getProtocols(filename, protocols, state, [&](pfwl_status_t status, pfwl_dissection_info_t) {
...
TEST(L3Dissection, igmp) {
  ...
  std::vector<uint> protocols;
  size_t id = 0;
  getProtocols("./pcaps/L3/igmp.pcap", protocols, state, [&](pfwl_status_t, pfwl_dissection_info_t r) {
    if (id == 0) {
      struct sockaddr_in src, dst;
